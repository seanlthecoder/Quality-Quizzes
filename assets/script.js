...
[
    ...
    choices: ["A - JavaScript is complementary to and integrated with HTML.", "B - JavaScript is an open and cross-platform.", "C - Both of the above.", "D - All of the above." ],
...
question: "Which of the following is the literal way to create an object with a property x of value 10?",
choices: [" A - {x: 10}", " B - new Object({x: 10})", "C - both a & b", " D - none" ],
...

{
    ...
    choices: ["A - bj.top-price", "B - obj['top-price']", "C - obj.accessProperty('top-price')", " D - Both a & b"  ],
...
answer: "Answer B - document.getElementById('demo').innerHTML = 'Hello World!';"

},

{
question: "Where is the correct place to insert a JavaScript?",
choices: ["A - The <body> section", "B - The <head> section", "C - Both the <head> section and the <body> section."],
